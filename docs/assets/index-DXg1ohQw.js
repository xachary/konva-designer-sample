...
Text$1.stringToArray = stringToArray$1;
  ...
  _sceneFunc(context) {
    ...
    for (n = 0; n < textArrLen; n++) {
      ...
      if (direction !== RTL && (letterSpacing !== 0 || align === JUSTIFY)) {
        spacesNumber = text.split(" ").length - 1;
        var array2 = stringToArray$1(text);
...
class Transformer extends Group_1.Group {
  ...
  __getNodeRect() {
    ...
    if (!node) {
      return {
        x: -MAX_SAFE_INTEGER$6,
        y: -MAX_SAFE_INTEGER$6,
        width: 0,
        height: 0,
        rotation: 0
      };
...
const _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("footer", null, null, -1));
